...
public class ClientController {
	...
	public Mono<String> getStudentById(@PathVariable("rollNumber") int rollNumber){
		...
		return client.get().uri(baseURI+"{rollNumber}",rollNumber)
				.headers(header -> header.setBasicAuth("india", "india"))
	...
	public Mono<String> updateMark(@PathVariable("rollNumber") int rollNumber ,
		 ...
		 return client.put()
			     .uri(baseURI+"{rollNumber}/{markToUpdate}",rollNumber,markToUpdate)
			        .retrieve()
	...
	public Mono<String> removeHotelById(@PathVariable("rollNumber") int rollNumber){


	  return client.delete()
	     .uri(baseURI+"{rollNumber}",rollNumber)
	        .retrieve()
	        .bodyToMono(String.class);
	}     
